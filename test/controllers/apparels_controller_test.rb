...
class ApparelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apparel" do
    assert_difference('Apparel.count') do
      post apparels_url, params: { apparel: { apparel_id: @apparel.apparel_id, article: @apparel.article, notes: @apparel.notes, sex: @apparel.sex, size: @apparel.size } }
    end
  ...
  test "should update apparel" do
    patch apparel_url(@apparel), params: { apparel: { apparel_id: @apparel.apparel_id, article: @apparel.article, notes: @apparel.notes, sex: @apparel.sex, size: @apparel.size } }
